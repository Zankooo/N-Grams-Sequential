...
Ta program je narejen zaporedno (sekvenčno). Ampak, ker je struktura programa takšna, da odpira možnosti za optimizacijo je na tem linku https://github.com/Zankooo/N-Grams-Paralell na voljo optimizirana verzija oziroma vzporedna (paralelna/več jedrna/večnitna/multithreading) različica. 
